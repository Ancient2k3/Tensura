...
local characters, skill_check = {
  ...
  ["Machine Gun Blows"] = true, ["Ignition Burst"] = false, ["Blitz Shot"] = false, ["Jet Dive"] = false, ["Incinerate"] = true, ["Speedblitz Dropkick"] = false, ["Thunder Kick"] = false, ["Flamewave Cannon"] = false
}
...
function _normal_tpto(pos)
  ...
  local hrp = plr and plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
  local hmoid = plr and plr.Character and plr.Character:FindFirstChild("Humanoid")
  if char and hrp and hmoid and hmoid.Health > 0 then
    char:PivotTo(CFrame.new(pos) * hrp.CFrame.Rotation)
  end
end
