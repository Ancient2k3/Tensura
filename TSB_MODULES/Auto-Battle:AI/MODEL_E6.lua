...
function _find_plr()
  ...
  end if t.r ~= nil or t.n ~= nil then
    if vars.aiming_mode == "nearby" then return t.n
    else return t.r or t.n
    end
  else
...
function _tpto(usr, pos)
  ...
  if hrp and hmoid and hmoid.Health > 0 then
    ...
    if _old_health > hmoid.Health then
      ...
      _chat_str("[BOT: Soru... " .. plrs[usr.Name].DisplayName:sub(1, 4) .. ", I'm behind you.")
    end
  end
end
...
function _normal_tpto(pos)
  ...
  local hmoid = plr and plr.Character and plr.Character:FindFirstChild("Humanoid")
  if hrp and hmoid and hmoid.Health > 0 then
    local _, _, _, r01, r02, r03, r04, r05, r06, r07, r08, r09 = hrp.CFrame:components()
    hrp.CFrame = CFrame.new(pos.X, pos.Y, pos.Z, r01, r02, r03, r04, r05, r06, r07, r08, r09)
  end
end
...
function _use_ult()
  ...
  if comm and ult then
    ...
    _chat_str("[BOT: " .. ({"It's ultimate time", "It's showcase time", "ROARRRRR.... LMAO LMAO."})[math.random(1, 3)] .. ".]")
  end
end
...
function _main_init()
  ...
  local hmoid = plr and plr.Character and plr.Character:FindFirstChild("Humanoid")
  if plr and plr.Character and target and hmoid then
    ...
    if target_hrp and hrp then _look_at(target)
      ...
      local behind_target = target_hrp.Position + (target_hrp.CFrame.LookVector * -5)
...
_chat_str("[MODEL_E5: AI Auto-Battle Started!]")
